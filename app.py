...
import dagshub
dagshub.init(repo_owner='divyavikb', repo_name='uber-demand-prediction', mlflow=True)

# set the mlflow tracking uri
mlflow.set_tracking_uri("https://dagshub.com/divyavikb/uber-demand-prediction.mlflow")
...
if date and time:
       ...
       colors = ["#FF0000", "#FF4500", "#FF8C00", "#FFD700", "#ADFF2F", 
              ...
              "#FFA07A", "#FFDAB9", "#85704D", "#F5DEB3", "#EEE8AA"]

       # add color to the data

       print(df_plot["region"].nunique())
